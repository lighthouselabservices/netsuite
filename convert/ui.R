...
shinyUI(bs4DashPage(
  ...
  body = bs4DashBody(
    ...
    fluidRow(
      class = "px-3 d-flex justify-content-start", style = "font-family: 'Roboto Condensed', 'Roboto', sans-serif;",
      div(
        pickerInput(
          inputId = "type",
      ...
      div(
        class = "ml-3", style = "font-size:12pt; ",
        fileInput("file_upload", "Upload Copper CRM File for Conversion (CSV ONLY)",
          width = 600,
          accept = c(
            "text/csv",
    ...
    fluidRow(
      ...
      tabBox(
        ...
        tabPanel(
          ...
          # input table
          div(
            class = "p-3", style = "font-size:10pt; font-family: 'Roboto Condensed', 'Roboto', sans-serif;",
